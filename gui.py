...
# check_call(['apt-get', 'install', '-y', 'xvfb'],
...
# Menu bar
    ...
    def msg(self):
        tkinter.messagebox.showinfo("BOT v1.0 ",'BOT is a retrieval based chatbot for answering government related queries queries')

    def about(self):
        tkinter.messagebox.showinfo("BOT Developers","1.Saketha\n2.Divya\n3.Sreelakka\n4.Joshitha\n")
    ...
    def send_message_insert(self, message):
        ...
        #t1.start()
        #time.sleep(1)
        print("gui input:",user_input)
        ob=bot.chat_with_bot(user_input.lower())
        pr="Bot : " + ob + "\n"
        self.text_box.configure(state=NORMAL)
